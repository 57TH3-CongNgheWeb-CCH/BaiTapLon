...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 30, 2018 lúc 03:32 PM
...
INSERT INTO `lienhe` (`Email`, `noidung`) VALUES
('hieunq52@wru.vn', 'dsfa '),
('hieunq52@wru.vn', 'dsfa '),
('hieunq52@wru.vn', 'a fds'),
('hieunq52@wru.vn', 'liÃªn há»‡'),
('hieunq52@wru.vn', 'hiáº¿u'),
('hieunq52@wru.vn', 'hiáº¿u'),
('hieunq52@wru.vn', 'liÃªn há»‡'),
('hieunq52@wru.vn', 'liÃªn há»‡'),
('abc', 'abc');
