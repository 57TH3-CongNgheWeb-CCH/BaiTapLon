...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2018 at 07:16 AM
...
CREATE TABLE `donhang` (
  ...
  `MaDon` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `MaKhach` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `MaThuoc` varchar(30) CHARACTER SET utf8 DEFAULT NULL,
  `TenThuoc` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `Gia` int(11) NOT NULL,
